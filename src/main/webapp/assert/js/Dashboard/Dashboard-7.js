...
$(document).ready(function () {
  ...
  $('#dashboard-7 .cards.first .card.one .item .circle').hover(function () {
    ...
    $('#dashboard-7 .cards.first .card .item .circle').css({
  ...
  $('#dashboard-7 .cards.second .card.one .item .circle').hover(function () {
    ...
    #dashboard-7 .cards.second .card.three .item .circle').css({
    ...
    #dashboard-7 .cards.third .card.three').css({
  ...
  $('#dashboard-7 .cards.second .card.four .item div:nth-child(1)').hover(function () {
    
    // "시계열 예측"에 선을 실선(solid)에서 점선(dashed)으로 바꾼다.
    $('#dashboard-7 .cards.second .card.four .item').css({
      'border': '5px dashed var(--color-green)'
    });

    $('#dashboard-7 .cards.third .card.seven').css({
      'border-right': '5px dashed var(--color-green)',
      'border-bottom': '5px dashed var(--color-green)',
      'border-radius': '0 0 20px 0'
    });

    $('#dashboard-7 .cards.fourth .card').css({
      'border-top': '5px dashed var(--color-green)',
      'top': '-15px'
    });

    $('#dashboard-7 .cards.fourth .card.seven').css({
      'border-top': 'none'
    });

    $('#dashboard-7 .cards.fourth .card.one').css({
